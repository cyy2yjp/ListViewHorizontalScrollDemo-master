...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        headSrcrollView = (HorizontalScrollView) mHead.findViewById(R.id.h_scrollView);
        mHead.setFocusable(true);
        mHead.setClickable(true);
        mHead.setOnTouchListener(new MyTouchLinstener());
        mListView.setHorizontalScrollView(headSrcrollView);
    ...
    HorizontalScrollView headSrcrollView =null;
